...
6090 PRINT AT 1,1;t$
6100 LET l$="                            "
6110 PRINT AT 2,1; CHR$ 144+l$+ CHR$ 144
6120 PRINT AT 3,1; CHR$ 153+l$+ CHR$ 157
6130 PRINT AT 4,1; CHR$ 154+l$+ CHR$ 158
6140 PRINT AT 5,1; CHR$ 155+l$+ CHR$ 159
6145 PRINT AT 6,1; CHR$ 155+l$+ CHR$ 159
6150 FOR i=7 TO 14
6160 PRINT AT i,1; CHR$ 156+l$+ CHR$ 160
6170 NEXT i
6175 PRINT AT 15,1; CHR$ 155+l$+ CHR$ 159
...
6331 LET t$="2. Look away"
6332 LET yposition=9
6340 PRINT AT 9,yposition; t$: FLASH 1: PRINT AT 9,yposition + LEN(t$); " "
6400 LET i$=INKEY$
...
9790 REM PLOT 5,155: DRAW 246,0: PLOT 5,154: DRAW 246,0
9800 REM REM LET d$="Date:"+STR$ month+"/"+STR$ day+"/"+STR$ year
9810 REM LET s$="Score:"+STR$ score
9820 REM PRINT AT 1,1; d$
9830 REM PRINT AT 1,20; s$
9890 RETURN
